...
SPLAT_PRODUCTS = [
    ...
    "TISH PASTASI KUNLIK OQARTIRUVCHI YALPIZ YOG'I-LIMON YOG'I 100GR SPLAT",
    "TISH YUVISH CHO'TKASI KO'MIRLI MEDIUM 1DONA BIOMED",
    "TISH YUVISH CHO'TKASI MEDIUM 1DONA BIOMED",
    "TISH YUVISH CHO'TKASI CLEAN CARE DAILY MEDIUM 1DONA SPLAT",
    "TISH YUVISH CHO'TKASI PROFESSIONAL WHITENING MEDIUM 1DONA SPLAT",
    "SOVUN EKOLOGIK LITSEYA-BERGAMOT 90GR BIOMIO 161122",
    "SOVUN EKOLOGIK ASSORTIMENTDA 90GR BIOMIO"
]
